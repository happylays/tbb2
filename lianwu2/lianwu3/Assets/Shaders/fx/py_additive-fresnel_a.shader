Shader "FxShader_py/py_add-fresnel_a" {
    Properties {
    ...
    SubShader {
        ...
        Pass {
            ...
            fixed4 frag(VertexOutput i) : COLOR {
                ...
                float3 emissive = (((_colorRGBA.rgb*_colorRGBA.a)*(((_color_strong*_tex01RGB_var.rgb)+(_tex01RGB_var.rgb*(pow(1.0-max(0,dot(normalDirection, viewDirection)),_fre_width)*_fre_strong)))+_all1))*(i.vertexColor.rgb*i.vertexColor.a));
