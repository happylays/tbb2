Shader "FxShader_py/py_additive_a" {
    Properties {
    ...
    SubShader {
        ...
        Pass {
            ...
            fixed4 frag(VertexOutput i) : COLOR {
                ...
                float4 _tex01RGB_var = tex2D(_tex01RGB,TRANSFORM_TEX(i.uv0, _tex01RGB));
                float3 emissive = (((_colorRGB.rgb*(_color_strong*_tex01RGB_var.rgb))*i.vertexColor.rgb)*(_colorRGB.a*i.vertexColor.a));
