...
public class UILabel : UIWidget
{
    ...
    [HideInInspector][SerializeField] bool mPartial = false;//Partial text - ADD BY XIONGHUI
	...
	string mPartialText = "";//Partial text - ADD BY XIONGHUI
	...
	void ProcessText ()
	{
		...
		//Partial text - ADD BY XIONGHUI
		if(mPartial && mMaxLineCount != 0)
		{
			ProcessorPartialText(mText);
			mProcessedText = mPartialText;
		}
		else
		{
