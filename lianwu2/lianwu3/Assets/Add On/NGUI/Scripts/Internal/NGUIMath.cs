...
{
	private static List<UIWidget> s_ListIgnoreWidget = new List<UIWidget>();
	...
	static public Bounds CalculateRelativeWidgetBounds (Transform root, Transform child,bool ignoreWidget)
	{
	...
	static bool NeedIgnoreWidget(UIWidget widget)
	{
		if(s_ListIgnoreWidget.Contains(widget))
		{
			return true;
		}
	...
	public static void AddIgnoreWidget(UIWidget widget)
	{
		s_ListIgnoreWidget.Add(widget);
	}

	public static void RemoveIgnoreWidget(UIWidget widget)
	{
		if(s_ListIgnoreWidget.Contains(widget))
		{
			s_ListIgnoreWidget.Remove(widget);
		}
	}
