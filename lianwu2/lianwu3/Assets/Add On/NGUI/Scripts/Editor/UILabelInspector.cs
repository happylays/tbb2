...
public class UILabelInspector : UIWidgetInspector
{
	...
	override protected bool DrawProperties ()
	{
		...
		if (mLabel.font != null)
		{
            ...
            GUILayout.BeginHorizontal();
            bool partialFlag = EditorGUILayout.Toggle("Partial", mLabel.supportPartial, GUILayout.Width(100f));
            GUILayout.Label("- display partial text");
            GUILayout.EndHorizontal();
            if (partialFlag != mLabel.supportPartial) { RegisterUndo(); mLabel.supportPartial = partialFlag; }
