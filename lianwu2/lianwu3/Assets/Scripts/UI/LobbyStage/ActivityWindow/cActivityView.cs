...
public class cActivityView : View
{
    public override UIFlag UIID
    {
        get { return UIFlag.ui_activity; }
    }

    //mvc
    private cActivityClip _uiClip;

    void Start()
    {
        //Awake();
        OnShowWnd();        
        CommonFunc.SetLayer(_uiClip.mainObject, GameLayer.UI, true, GameLayer.NONE);
    }
    ...
    public void initView()
    {
        if (_uiClip == null)
        {
            _uiClip = new cActivityClip(this.gameObject);            
        }
    }
